    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Crear Nuevo Componente</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('componentes.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tipo_componente_id" id="tipo_componente_id" class="form-control @error('tipo_componente_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($tiposComponente as $tipo)
                                        <option value="{{ $tipo->id }}" {{ old('tipo_componente_id') == $tipo->id ? 'selected' : '' }}>
                                            {{ $tipo->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="especificaciones" id="especificaciones" 
                                  ...
                                  rows="3" 
                                  placeholder="Ingrese las especificaciones técnicas del componente">{{ old('especificaciones') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="fecha_adquisicion" id="fecha_adquisicion" 
                                       ...
                                       value="{{ old('fecha_adquisicion', date('Y-m-d')) }}" required>
