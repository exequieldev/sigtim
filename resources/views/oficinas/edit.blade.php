    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Editar Oficina</h5>
            </div>
            <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('departamento_id') is-invalid @enderror" 
                                    ...
                                    @foreach($departamentos as $departamento)
                                        <option value="{{ $departamento->id }}" {{ old('departamento_id', $oficina->departamento_id) == $departamento->id ? 'selected' : '' }}>
                                            {{ $departamento->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          placeholder="Describa las funciones y características de la oficina">{{ old('descripcion', $oficina->descripcion) }}</textarea>
                                @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
