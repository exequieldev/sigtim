...
@section('title', 'Registrar Nuevo Programa')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Registrar Nuevo Programa</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('programas.store') }}" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                          ...
                                          rows="3" 
                                          placeholder="Describa las funciones y características del programa">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('sistema_operativo') is-invalid @enderror" 
                                    ...
                                    <option value="Windows" {{ old('sistema_operativo') == 'Windows' ? 'selected' : '' }}>Windows</option>
                                    <option value="Linux" {{ old('sistema_operativo') == 'Linux' ? 'selected' : '' }}>Linux</option>
                                    <option value="macOS" {{ old('sistema_operativo') == 'macOS' ? 'selected' : '' }}>macOS</option>
                                    <option value="Multiplataforma" {{ old('sistema_operativo') == 'Multiplataforma' ? 'selected' : '' }}>Multiplataforma</option>
                                    <option value="Web" {{ old('sistema_operativo') == 'Web' ? 'selected' : '' }}>Aplicación Web</option>
                                    <option value="Android" {{ old('sistema_operativo') == 'Android' ? 'selected' : '' }}>Android</option>
                                    <option value="iOS" {{ old('sistema_operativo') == 'iOS' ? 'selected' : '' }}>iOS</option>
                                    <option value="Otro" {{ old('sistema_operativo') == 'Otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <a href="{{ route('programas.index') }}" class="btn btn-secondary me-md-2">
